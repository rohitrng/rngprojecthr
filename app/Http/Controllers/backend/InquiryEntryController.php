...
// die();
    ...
    // public function adminenquirylist()
    // {   
    //      $all_inquiry = DB::connection('dynamic')->table('inquiry_registration')->where('is_delete',0)->where('status','i')->get(); //CommanModel::fetchDataWhere('inquiry_registration',['status'=>'i']);
